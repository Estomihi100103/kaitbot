                    ...
                    <nav aria-label="Global" className="flex items-center justify-between lg:px-8">
                        <div className="flex lg:flex-1">
                            <a href="/" className="-m-1.5 p-1.5">
                                <span className="sr-only">Kait Bot</span>
                                <img
                                    alt="KaitBot"
                                    src="/logo.png"
                ...
                <div className="relative isolate px-6 pt-14 lg:px-8">
                    ...
                    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 sm:h-96">
                        <div className="text-center">
                            ...
                            <a
                                    href="https://api.whatsapp.com/send?phone=6281264825759&text=Halo%20KaitBot"
                                    className="rounded-md px-3.5 py-2.5 text-sm font-semibold text-gray-900 border border-gray-500 hover:border-gray-50 shadow-xs hover:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
                                    Kontak Kami
                                </a>
                            </div>
